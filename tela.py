...
class principal:
    ...
    def __init__(self,janela=None):
        ...
        self.btreceita = Button(janela, text="Receitas", width=40, height= 5,background="green",command= self.Receitas)
        self.btreceita.place(x=50, y=150)       

        self.btconexao = Button(janela, text="Login APP", width=40,height= 5,background="yellow")
    ...
    def receita_nova(self):
        ...
        self.bt_confirma_recnova=Button(rec_nova, text="Confirmar",background="green", width=40, height=5,command=self.conf_rampas)
        self.bt_confirma_recnova.place(x=150,y=300)
        self.bt_cancela_recnova=Button(rec_nova, text="Cancelar",background="red", width=30, height=5,command=rec_nova.destroy)
        self.bt_cancela_recnova.place(x=450,y=300)
        rec_nova.geometry("800x480")
