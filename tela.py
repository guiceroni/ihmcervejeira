...
class principal:
    ...
    def conf_rampas(self):
        ...
        self.lb_rampa1.place(x=180,y=180)
        ...
        self.wr_escolhe_temp.place(x=400, y=195)
        self.lb_rampa_tempo1=Label(conf_rampas,text="Tempo para Rampa 1: ",font="Arial 15")
        self.lb_rampa_tempo1.place(x=180,y=220)
        ...
        self.wr_seleciona_tempo.place(x=400, y=225)
    ...
    def conf_fervura(self):
        ...
        self.lb_conf_fervura_combo.place(x=180,y=220)
        ...
        self.wr_seleciona_fervura.place(x=400, y=225)
